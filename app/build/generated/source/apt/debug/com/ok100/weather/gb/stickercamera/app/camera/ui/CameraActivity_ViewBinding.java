...
public class CameraActivity_ViewBinding implements Unbinder {
  ...
  public CameraActivity_ViewBinding(CameraActivity target, View source) {
    ...
    target.surepicture = Utils.findRequiredViewAsType(source, R.id.surepicture, "field 'surepicture'", Button.class);
    ...
    target.root_view_layout = Utils.findRequiredViewAsType(source, R.id.root_view_layout, "field 'root_view_layout'", RelativeLayout.class);
    ...
    target.view_preview_img = Utils.findRequiredViewAsType(source, R.id.view_preview_img, "field 'view_preview_img'", ImageView.class);
  }
